...
def get_features_candidate(model: Model, candidate, max_dimensions: int, max_blocks: int):
    ...
    for i in range(max_dimensions):
        ...
        for j in range(max_blocks):
            feat_vect.append(feat.dims_block_is_shared(i, model.var_dims_divisors, j))
            feat_vect.append(feat.dims_block_max(i, model.var_dims_divisors, j))
            feat_vect.append(feat.dims_block_min(i, model.var_dims_divisors, j))
            feat_vect.append(feat.dims_block_mean(i, model.var_dims_divisors, j))
            feat_vect.append(feat.dims_block_mean_diff(i, model.var_dims_divisors, j))
